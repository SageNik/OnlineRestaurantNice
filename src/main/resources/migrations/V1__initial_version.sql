...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `enabled` int(5) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (username, password,enabled ) VALUES ('Admin','$2a$04$m6twIdQCX1nc2vJXc7yeiuzohKIBerH7aAjZgMtcaqGQL8TQ1IJ5S', true);
INSERT INTO `user` (username, password,enabled ) VALUES ('User','$2a$04$cWXch6Hg0Ka/L3p7.szXDu1Rj1/Q/K25BFkN30hADJWZA18wo8dVa', true);
